        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(verificationCode))
                {
                    ...
                    Toast.makeText(PhoneLoginActivity.this, "Please wirte verification code first", Toast.LENGTH_SHORT).show();
                ...
                else
                {
                    ...
                    loadingBar.setMessage("Please wait, while we verified your verification code");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>()
                {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(PhoneLoginActivity.this, "Login succefuly",Toast.LENGTH_SHORT).show();
